    ...
    public class MemberPermissionNavigationProperties {
        ...
        public void PolicyAllow_NavigationMemberDeny() {
            ...
            using(DbContextConnectionClass dbContextConnectionClass = new DbContextConnectionClass()) {
                ...
                dbContextConnectionClass.Security.AddMemberPermission(SecurityOperation.Read, OperationState.Deny, "Person", SecurityTestHelper.CompanyNameEqualsOne);
        ...
        public void PolicyDeny_NavigationMemberAllow() {
            ...
            using(DbContextConnectionClass dbContextConnectionClass = new DbContextConnectionClass()) {
                ...
                dbContextConnectionClass.Security.AddMemberPermission(SecurityOperation.Read, OperationState.Allow, "Person", SecurityTestHelper.CompanyNameEqualsOne);
        ...
        public void Read_PolicyDeny_OneMemberAllow_IncludeNavigateObject_SaveChanges() {
            ...
            using(DbContextConnectionClass dbContextConnectionClass = new DbContextConnectionClass()) {
                ...
                dbContextConnectionClass.Security.AddMemberPermission(SecurityOperation.ReadWrite,OperationState.Allow, "Person", SecurityTestHelper.CompanyNameEqualsOne);
                dbContextConnectionClass.Security.AddMemberPermission(SecurityOperation.ReadWrite, OperationState.Allow, "Description", SecurityTestHelper.CompanyTrue);
