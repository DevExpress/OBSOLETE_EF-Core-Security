...
namespace DevExpress.EntityFramework.SecurityDataStore.Security {
    public class SecurityObjectRepository {
        public List<SecurityObjectMetaData> resource = new List<SecurityObjectMetaData>();
        public bool TryRemoveObject(object targetObject) {
            bool result;
            SecurityObjectMetaData objToRemove = resource.FirstOrDefault(p => p.SecurityObject == targetObject || p.RealObject == targetObject);
            if(objToRemove != null) {
        ...
        public List<string> GetBlockedMembers(object securityObject) {
            SecurityObjectMetaData securityObjectMetaData = resource.FirstOrDefault(p => p.SecurityObject == securityObject);
        ...
        public SecurityObjectMetaData GetSecurityObjectMetaData(object targetObject) {
        ...
        public void RegisterObjects(SecurityObjectMetaData securityObjectMetaData) {
